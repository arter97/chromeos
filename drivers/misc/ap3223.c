...
#define INIT_ARKHAM
/* platform related register initialization should be done in user space
...
static struct class *ap3223_class;
static struct device *ap3223_dev;
...
static void destroy_sysfs_interfaces(void)
{
	int i;
	for (i = ARRAY_SIZE(attributes)-1; i >= 0; i--)
		device_remove_file(ap3223_dev, attributes + i);
			...
			const struct i2c_device_id *id)
{
	...
	i2c_smbus_write_byte_data(client, 0x0, 0x4); /* SW reset */

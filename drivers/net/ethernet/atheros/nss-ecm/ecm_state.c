...
static bool ecm_state_char_dev_conn_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "conns");
	if (result)
		return result;
...
static bool ecm_state_char_dev_mapping_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "mappings");
	if (result)
		return result;
...
static bool ecm_state_char_dev_host_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "hosts");
	if (result)
		return result;
...
static bool ecm_state_char_dev_node_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "nodes");
	if (result)
		return result;
...
static int ecm_state_char_dev_iface_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "ifaces");
	if (result)
		return result;
...
static bool ecm_state_char_dev_conn_chain_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "conn_chain");
	if (result)
		return result;
	result = ecm_state_prefix_index_add(sfi, sfi->connection_hash_index);
	if (result)
		return result;
...
static bool ecm_state_char_dev_mapping_chain_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "mapping_chain");
	if (result)
		return result;
	result = ecm_state_prefix_index_add(sfi, sfi->mapping_hash_index);
	if (result)
		return result;
	return ecm_state_write(sfi, "length", "%d", chain_len);
}
...
static bool ecm_state_char_dev_host_chain_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "host_chain");
	if (result)
		return result;
	result = ecm_state_prefix_index_add(sfi, sfi->host_hash_index);
	if (result)
		return result;
	return ecm_state_write(sfi, "length", "%d", chain_len);
}
...
static bool ecm_state_char_dev_node_chain_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "node_chain");
	if (result)
		return result;
	result = ecm_state_prefix_index_add(sfi, sfi->node_hash_index);
	if (result)
		return result;
	return ecm_state_write(sfi, "length", "%d", chain_len);
}
...
static bool ecm_state_char_dev_iface_chain_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "iface_chain");
	if (result)
		return result;
	result = ecm_state_prefix_index_add(sfi, sfi->iface_hash_index);
	if (result)
		return result;
	return ecm_state_write(sfi, "length", "%d", chain_len);
}
...
static bool ecm_state_char_dev_protocol_count_msg_prep(struct ecm_state_file_instance *sfi)
{
	...
	result = ecm_state_write_reset(sfi, "protocol");
	if (result)
		return result;
	result = ecm_state_prefix_index_add(sfi, sfi->protocol);
	if (result)
		return result;

...
static struct tegra_clk tegra124_clks[tegra_clk_max] __initdata = {
	...
	[tegra_clk_cam_mclk] = { .dt_id = TEGRA124_CLK_CAM_MCLK, .present = true },
	[tegra_clk_cam_mclk2] = { .dt_id = TEGRA124_CLK_CAM_MCLK2, .present = true },
	...
	[tegra_clk_vi_sensor2_8] = { .dt_id = TEGRA124_CLK_VI_SENSOR2, .present = true },
...
static struct tegra_devclk devclks[] __initdata = {
	...
	{ .con_id = "csus", .dt_id = TEGRA124_CLK_CSUS },
	...
	{ .con_id = "cilab", .dt_id = TEGRA124_CLK_CILAB },
	{ .con_id = "cilcd", .dt_id = TEGRA124_CLK_CILCD },
	{ .con_id = "cile", .dt_id = TEGRA124_CLK_CILE },
	{ .con_id = "vi_sensor", .dt_id = TEGRA124_CLK_VI_SENSOR },
	{ .con_id = "vi_sensor2", .dt_id = TEGRA124_CLK_VI_SENSOR2 },
	{ .con_id = "cam_mclk", .dt_id = TEGRA124_CLK_CAM_MCLK },
	{ .con_id = "cam_mclk2", .dt_id = TEGRA124_CLK_CAM_MCLK2 },
};
...
static struct tegra_clk_init_table init_table[] __initdata = {
	...
	{TEGRA124_CLK_VI, TEGRA124_CLK_PLL_P, 408000000, 0},
	{TEGRA124_CLK_CSI, TEGRA124_CLK_PLL_P, 408000000, 0},
	{TEGRA124_CLK_ISP, TEGRA124_CLK_PLL_P, 0, 0},
	{TEGRA124_CLK_EMC, TEGRA124_CLK_CLK_MAX, 0, 1},
	{TEGRA124_CLK_VI_SENSOR, TEGRA124_CLK_PLL_P, 24000000, 0},
	{TEGRA124_CLK_VI_SENSOR2, TEGRA124_CLK_PLL_P, 24000000, 0},
	{TEGRA124_CLK_DSIALP, TEGRA124_CLK_PLL_P, 0, 0},
	{TEGRA124_CLK_DSIBLP, TEGRA124_CLK_PLL_P, 0, 0},
	{TEGRA124_CLK_CILAB, TEGRA124_CLK_PLL_P, 102000000, 0},
	{TEGRA124_CLK_CILCD, TEGRA124_CLK_PLL_P, 102000000, 0},
	{TEGRA124_CLK_CILE, TEGRA124_CLK_PLL_P, 102000000, 0},

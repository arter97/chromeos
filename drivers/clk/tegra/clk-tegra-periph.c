...
static struct tegra_periph_init_data periph_clks[] = {
	...
	MUX("vi_sensor2", mux_pllm_pllc_pllp_plla, CLK_SOURCE_VI_SENSOR2, 20, TEGRA_PERIPH_NO_RESET, tegra_clk_vi_sensor2),
	...
	MUX8("vi_sensor2", mux_pllm_pllc2_c_c3_pllp_plla, CLK_SOURCE_VI_SENSOR2, 20, TEGRA_PERIPH_NO_RESET, tegra_clk_vi_sensor2_8),
...
static struct tegra_periph_init_data gate_clks[] = {
	...
	GATE("csi", "pll_p", 52, 0, tegra_clk_csi, 0),
	...
	GATE("vim2_clk", "pll_ref", 171, 0, tegra_clk_vim2_clk, 0),
	GATE("pcie", "clk_m", 70, 0, tegra_clk_pcie, 0),
	GATE("dpaux", "clk_m", 181, 0, tegra_clk_dpaux, 0),
	GATE("gpu", "pll_ref", 184, 0, tegra_clk_gpu, 0),
	GATE("cam_mclk", "pll_ref", 164, 0, tegra_clk_cam_mclk, 0),
	GATE("cam_mclk2", "pll_ref", 165, 0, tegra_clk_cam_mclk2, 0),
};
